...
`;var b="/assets/logo.e5cbf81a.svg",y="/assets/icon-hamburger.0c2573b0.svg";const w=a.header`
    display:flex;
...
`;var C="/assets/icon-close.4ba9bc15.svg";const z=({close:t,setClose:i})=>{const o=["Pricing","Product","About Us","Careers","Community"];return e.createElement(w,null,e.createElement("img",{src:b,alt:""}),e.createElement(E,{close:t},o.map((l,n)=>e.createElement("p",{key:n},l))),e.createElement(k,{onClick:()=>i(!t)},e.createElement("img",{src:t?C:y,alt:"hamburger/close"})),e.createElement(p,null,"Get Started"))},M=a.footer`
...
`,X=()=>e.createElement(Q,null,e.createElement("h1",null,"Simplify how your team works today."),e.createElement(p,{responsive:!0,white:!0},"Get Started"));function Y(){const[t,i]=d.exports.useState(!1);return e.createElement(e.Fragment,null,e.createElement(v,null),e.createElement(z,{close:t,setClose:i}),e.createElement(q,null),e.createElement(X,null),e.createElement(N,null))}h.render(e.createElement(Y,null),document.getElementById("root"));
