import{W as g,s as a,R as e,r as d,A as u,a as h}from"./vendor.fe96c187.js";const x=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&l(s)}).observe(document,{childList:!0,subtree:!0});function r(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function l(n){if(n.ep)return;n.ep=!0;const i=r(n);fetch(n.href,i)}};x();var f="/manage-landing-page-master/assets/bg-tablet-pattern.1b3e62f1.svg";const v=g`
    body{
        overflow-x: hidden;
        margin:0;
        padding:0;
...
`;var b="/manage-landing-page-master/assets/logo.e5cbf81a.svg",y="/manage-landing-page-master/assets/icon-hamburger.0c2573b0.svg";const w=a.header`
    display:flex;
...
`;var C="/manage-landing-page-master/assets/icon-close.4ba9bc15.svg";const z=({close:t,setClose:o})=>{const r=["Pricing","Product","About Us","Careers","Community"];return e.createElement(w,null,e.createElement("img",{src:b,alt:""}),e.createElement(E,{close:t},r.map((l,n)=>e.createElement("p",{key:n},l))),e.createElement(k,{onClick:()=>o(!t)},e.createElement("img",{src:t?C:y,alt:"hamburger/close"})),e.createElement(p,null,"Get Started"))},M=a.footer`
...
`;var U=[{num:"01",title:"Track company-wide progress",text:"  See how your day-to-day tasks fit into the wider vision. Go from tracking progress at the milestone level all the way done to the smallest of details. Never lose sight of the bigger picture again."},{num:"02",title:"Advanced built-in reports",text:"Set internal delivery estimates and track progress toward company goals. Our customisable dashboard helps you build out the reports you need to keep key stakeholders informed."},{num:"03",title:"Everything you need in one place",text:"Stop jumping from one service to another to communicate, store files, track tasks and share documents. Manage offers an all-in-one team productivity solution."}],D=[{avatar:"assets/avatar-anisha.png",author:"Anisha Li",comment:"\u201CManage has supercharged our team\u2019s workflow. The ability to maintain visibility on larger milestones at all times keeps everyone motivated.\u201D"},{avatar:"assets/avatar-ali.png",author:"Ali Bravo",comment:"\u201CWe have been able to cancel so many other subscriptions since using Manage. There is no more cross-channel confusion and everyone is much more focused.\u201D"},{avatar:"assets/avatar-richard.png",author:"Richard Watts",comment:"\u201CManage allows us to provide structure and process. It keeps us organized and focused. I can\u2019t stop recommending them to everyone I talk to!\u201D"},{avatar:"assets/avatar-shanai.png",author:"Shanai Gough",comment:"\u201CTheir software allows us to track, manage and collaborate on our projects from anywhere. It keeps the whole team in-sync without being intrusive.\u201D"}];const q=()=>{const t=D.map((r,l)=>e.createElement(W,null,e.createElement("img",{key:l,src:r.avatar,alt:"imagen"}),e.createElement("b",null,r.author),e.createElement("p",null,r.comment))),o={0:{items:1},1024:{items:3}};return e.createElement("main",null,e.createElement(O,null,e.createElement(B,{src:R}),e.createElement(m,null,e.createElement("h1",null,"Bring everyone together to build better products."),e.createElement("p",null,"Manage makes it simple for software teams to plan day-to-day tasks while keeping the larger team goals in view."),e.createElement(p,{responsive:!0},"Get Started"))),e.createElement(H,null,e.createElement(m,null,e.createElement("h2",null,"What\u2019s different about Manage?"),e.createElement("p",null,"Manage provides all the functionality your team needs, without the complexity. Our software is tailor-made for modern digital product teams.")),e.createElement("div",null,U.map((r,l)=>e.createElement(T,{key:l},e.createElement("div",null,e.createElement("span",null,r.num),e.createElement("b",null,r.title)),e.createElement("p",null,r.text))))),e.createElement(F,null,e.createElement(m,{center:!0},e.createElement("h2",null,"What they\u2019ve said")),e.createElement(u,{responsive:o,disableButtonsControls:!0,mouseTracking:!0,items:t}),e.createElement(p,{responsive:!0},"Get Started")))};var K="/manage-landing-page-master/assets/bg-simplify-section-mobile.d5a2eb69.svg",J="/manage-landing-page-master/assets/bg-simplify-section-desktop.830b4ec0.svg";const Q=a.div`
...
`,X=()=>e.createElement(Q,null,e.createElement("h1",null,"Simplify how your team works today."),e.createElement(p,{responsive:!0,white:!0},"Get Started"));function Y(){const[t,o]=d.exports.useState(!1);return e.createElement(e.Fragment,null,e.createElement(v,null),e.createElement(z,{close:t,setClose:o}),e.createElement(q,null),e.createElement(X,null),e.createElement(N,null))}h.render(e.createElement(Y,null),document.getElementById("root"));
